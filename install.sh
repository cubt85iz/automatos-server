...
INCLUDED_PACKAGES=(borgbackup curl dbus-tools firewalld iwlegacy-firmware iwlwifi-dvm-firmware iwlwifi-mvm-firmware just kernel-modules-extra nano podman rclone rsync-daemon samba vim wget xdg-dbus-proxy xdg-user-dirs)
